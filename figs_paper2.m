...
hlabel(1) = annotation(hax(1).Parent, 'textbox', [0.4 0.18 0.05 0.05], ...
...
axes(hax(3));
view(-130, 28);
hanno(3) = annotation(hax(3).Parent, 'textarrow', [0.40 0.47], [0.78 0.7], ...
                    ...
                    'the streamer water'; 'above it.'}, ...
                      ...
                      'HeadStyle', annoheadstyle, 'FontSize', annofs, ...
                      'VerticalAlignment', 'middle');
hanno(4) = annotation(hax(3).Parent, 'textarrow', [0.66 0.57], [0.53 0.61], ...
                    ...
                    'below'; 'shelfbreak depth'}, ...
                      ...
                      'HeadStyle', annoheadstyle, 'FontSize', annofs, ...
                      'VerticalAlignment', 'middle');
hlabel(3) = annotation(hax(3).Parent, 'textbox', [0.4 0.18 0.05 0.05], ...
                       'String', '(c)', 'EdgeColor', 'none');

axes(hax(4));
view(-128, 40);
hanno(5) = annotation(hax(4).Parent, 'textarrow', [0.42 0.46], [1 1]*0.75, ...
                      'String', {'Cyclone propagates'; ...
                    'away with trapped';  'streamer water.'}, ...
                      'LineWidth', annolw, 'Color', annocolor, ...
                      'HeadStyle', annoheadstyle, 'FontSize', annofs, ...
                      'VerticalAlignment', 'middle');
hanno(6) = annotation(hax(4).Parent, 'textarrow', [0.65 0.57], [0.53 0.61], ...
