...
ndloc = csf.array(1).csflux.ndloc(param.isobath);
errorbar(ndloc, param.slope, param.merr, 'k.-', 'LineWidth', 2, 'MarkerSize', 20);
hold on;
...
htxt(1) = text(1.52,0.40,'Slope (m)', 'FontSize', 18, 'HorizontalAlignment', 'center');
