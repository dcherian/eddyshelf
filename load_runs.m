o%% do this as an array
rootdir = '';
folders = { ...
    'runew-03', 'runew-04', 'runew-05', 'runew-06', ...
    'runew-13', 'runew-15', ...
... % 'runew-24','runew-25', 'runew-26', ...
    'runew-332', 'runew-342', 'runew-352', 'runew-362', ...
    'runew-44', 'runew-45', ...
    'runew-640-closer', 'runew-641', ...
    'runew-650-closer', 'runew-651', 'runew-6052', 'runew-6152', ...
    'runew-6062', ...
    'runew-840', 'runew-841', ...
    'runew-850', 'runew-851', ...
          };
...
%% slope
folders = { ...
    'runew-04', 'runew-640', 'runew-641', 'runew-642', ...
    'runew-15', 'runew-650', 'runew-651', 'runew-6152', ...
    'runew-05', 'runew-6052', ...
    'runew-06', 'runew-6062', ...
          };
sl = runArray(folders);
