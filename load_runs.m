...
folders = { ...
    ...
    'runew-6342', ... %'runew-6343', ...
    ... %'runew-6353', ...
    'runew-6362', 'runew-6362-1', 'runew-6362-2', ... %'runew-6363', ...
    'runew-6371', 'runew-6372', ... %'runew-6373', ...
    'runew-6452', ...
          };
all12 = runArray(folders);
...
%% process
folders = { ...
    'runew-6342', 'runew-5341', 'runew-5343' ...
          };
...
%'runew-04', 'runew-6040', 'runew-6041', 'runew-6042-new', ...
    ...
    'runew-34', 'runew-6342', ...%'runew-6343', ...
    'runew-35', ...%'runew-6353', ...
    'runew-36', 'runew-6362', 'runew-6362-1',...
    'runew-37', 'runew-6371', 'runew-6372', 'runew-6373' ...
    'runew-6452', ...
    ... %'runew-05', 'runew-6052', ...
    ... %'runew-06', 'runew-6062', ...
          };
...
for ii=1:sl.len
    ...
    slSa(ii) = sl.array(ii).bathy.S_sl;
    slRo(ii) = sl.array(ii).eddy.Ro(1);
    sl.sort_param(ii) = slRo(ii)./slSa(ii);
    %slRo = sl.array(ii).eddy.V(1)./sl.array(ii).params.phys.f0/sl.array(ii).bathy.L_slope;
...
%% shelfbreak depth
folders = {...
    'runew-34', 'runew-2340', 'runew-2341', 'runew-2342', ...
    'runew-36', 'runew-2360', 'runew-2361', 'runew-2362', ...
    'runew-6362-1', ...
    'runew-2361_wider', 'runew-2362_wide', ...
    ... %'runew-9340', 'runew-9341', ...
    };
sb = runArray(folders);
for ii=1:sb.len
