...
%% shelf slopes
folders = { ...
    'runew-04', 'runew-05', 'runew-15', ...
    'runew-34', 'runew-35', 'runew-36', 'runew-37', ...
    'runew-8040', 'runew-8041', 'runew-8042', ...
    'runew-8150', 'runew-8151', ...
    'runew-8341', 'runew-8342', 'runew-8343', ...
          };
sh = runArray(folders);

for ii=1:sh.len
    sh.array(ii).avgStreamerVelSection;
end
...
folders = { ...
    ...
    'runew-3340-80km' , 'runew-3341-2-big', ...
    'runew-23340', ...
    'runew-4040', 'runew-4050', ...
    'runew-4341', 'runew-4343', ...
    'runew-5341', 'runew-5343', ...
...
didntwork = [];
for ii=15:16 %:csf.len
    if isempty(strfind(csf.array(ii).eddy.hash, '801633fe52c9a30'))
...
%% older runs
folders = { ...
    'runew-b360', 'runew-b362', ...
    ... %'runew-a330', 'runew-a340', ...
          };
older = runArray(folders);

older.array(end).csfluxes;

%% csflux
folders = { ...
    'runew-03', 'runew-04', 'runew-05', 'runew-06', ...
    'runew-6341', 'runew-6371', ...
    'runew-2360-20km', ...
    'runew-2362_wider', ...
    'runew-5341', 'runew-5343', ...
    'runew-8342', 'runew-8343', ...
          };
csf2 = runArray(folders);

for ii=1:csf2.len
    csf2.array(ii).csfluxes;
end
