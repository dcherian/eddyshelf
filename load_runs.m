...
for ii=17:23
    ...
    %end
    if ~isfield(all.array(ii).eddy, 'rhovor')
        track_eddy(all.array(ii).dir);
    end
end
...
folders = { ...
    ...
    ... %'runew-2360', 'runew-2360-20km', ...
    'runew-2360_wider','runew-2361_wider', ...
    'runew-3340' , 'runew-3341-2', ...
    'runew-4341', 'runew-4343', ...
    'runew-5341', 'runew-5343'};
...
for ii=1:csf.len
    ...
    try
        ...
        if ~isfield(run.csflux, 'westmask')
            run.csfluxes;
        end
        csf.array(ii) = runs(run.dir);
    catch ME
    end
end
...
folders = {...
    ...
    'runew-36', 'runew-2360', 'runew-2360_wider', ...
